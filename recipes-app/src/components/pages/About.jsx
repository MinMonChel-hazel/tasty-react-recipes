...
export default function About() {
  return (
    <div
      id="about"
      className="px-10 min-h-screen bg-amber-100 flex flex-col md:flex-row items-center justify-center gap-6"
    >
      <div className="flex-0 md:flex-1">
        <h3 className="text-amber-500 font-bold text-2xl lg:text-3xl mb-2">
          About Us
        </h3>
        <p className="text-gray-600 text-[13px] lg:text-base mb-1">
        ...
        <p className="text-gray-600 text-[13px] lg:text-base">
